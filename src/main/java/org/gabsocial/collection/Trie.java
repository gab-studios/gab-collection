...
{
    /**
     * Gets words that are a close match to the prefix. If the word dictionary
     * includes: "he", "hello", "helloworld" and the prefix is "hel" or "hel111"
     * then the return list should include "hello" and "helloworld"
     * 
     * @param prefix
     *            A <code>String</code>instance. Must not be null or empty.
     * @return A <code>List</code> instance containing a matching set of words.
     *         May be empty if words were not found.
     */
     ...
     * 
     * @return A <code>List</code> instance containing String words.
     *         May be empty if words were not found.
     */
