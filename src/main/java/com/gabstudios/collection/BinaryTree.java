...
public class BinaryTree<T> {
	...
	public static class Node<T> {
		 ...
		 */
		protected Node(final BinaryTree<T> tree, final Node<T> parent, final T data) {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#setLeftChild(T)
		 */
		public Node<T> setLeftChild(final T data) {
			...
			if (this._leftChild != null) {
				throw (new IllegalStateException("The left child needs to be removed before you can set a new child."));
			} else {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#setRightChild(T)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#getData()
		 */
		public T getData() {
			return (this._data);
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#getLeftChild()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#getParent()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#getRightChild()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#isEmpty()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#isLeaf()
		 */
		public boolean isLeaf() {
			final boolean isLeaf = (this._leftChild == null) && (this._rightChild == null);
			return (isLeaf);
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#isRoot()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.gabsocial.collection.Node#removeLeftChild()
		 */
		...
		/*
		 * Sets the parent of the node. This is called when the addChild method is
		 * called.
		 */
	...
	/**
	 * Constructor of the Tree. A Tree must have one <code>Node</code> instance that
	 * is the root.
	 * 
	 * @param data
	...
	/**
	 * Gets all of the leaf data sorted by in ordering. A leaf is a Node that does
	 * not have children.
	 * 
	...
	/**
	 * Gets all of the data within the leaf nodes. A leaf is a Node that does not
	 * have children.
	 * 
	 * @return A <code>List</code> instance containing the leaf node data.
	 */
	...
	/**
	 * Gets the number of nodes contained in this tree. A Tree instance will always
	 * have one node that is the root;
	 * 
	...
	/**
	 * Gets all of the leaf data sorted by Post ordering. A leaf is a Node that does
	 * not have children.
	 * 
	 * @return A <code>List</code> instance containing the leaf node data.
	 */
	...
	/**
	 * Gets all of the leaf data sorted by pre ordering. A leaf is a Node that does
	 * not have children.
	 * 
	 * @return A <code>List</code> instance containing the leaf node data.
	 */
